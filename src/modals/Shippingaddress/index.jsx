      ...
      <div className="max-h-[97vh] overflow-y-auto sm:w-full md:w-full">
        <div className="bg-white_A700 flex flex-col gap-10 items-end justify-start mb-[511px] p-[50px] md:px-5 rounded-[16px] w-full">
          <div className="flex flex-row items-center justify-between w-[67%] md:w-full">
            <Text className="font-medium text-black_900" as="h6" variant="h6">
              Shipping address
            </Text>
            <Img
          ...
          <div className="flex flex-col gap-[54px] items-center justify-start mb-2.5 mr-2.5 w-[98%] md:w-full">
            <div className="flex flex-col items-start justify-start w-full">
              <Text className="font-medium text-gray_900" variant="body3">
                Shipping address
              </Text>
              <div className="flex sm:flex-col flex-row gap-4 items-center justify-between mt-[13px] rounded-lg w-full">
                ...
                ></Input>
                <Button
                  className="cursor-pointer font-normal min-w-[166px] text-center text-lg text-white_A700"
                  shape="RoundedBorder8"
                  size="lg"
              ...
              <div className="flex flex-row gap-4 items-end justify-start mt-[17px] w-[37%] md:w-full">
                ...
                />
                <Text
                  className="font-normal mt-[5px] text-indigo_300"
                  variant="body3"
                >
                  ...
                  <div className="flex flex-row gap-3.5 items-end justify-between mb-[25px] mt-[5px] w-[99%] md:w-full">
                    ...
                    <div className="flex flex-col gap-[13px] items-start justify-start mt-[7px]">
                      <div className="flex flex-col items-start justify-start">
                        <Text className="text-gray_900" variant="body5">
                          Highbridge House
                        </Text>
                        <Text
                          className="leading-[153.00%] mt-2 text-gray_900 w-full"
                          variant="body8"
                        >
                          1131 Ogden Ave, Bronx, NY 10452, Amerika Serikat
                        </Text>
                        <Text
                          className="mt-[11px] text-gray_900"
                          variant="body8"
                        >
                      ...
                      <Button
                        className="cursor-pointer font-semibold min-w-[185px] text-[12.99px] text-center text-white_A700"
                        shape="RoundedBorder8"
                        size="lg"
                        variant="FillRed500"
                      >
