    ...
    <>
      <footer className={props.className}>
        <div className="flex flex-col md:gap-10 gap-[67px] items-center justify-center mb-[76px] mt-[70px] mx-auto w-[78%]">
          <div className="flex md:flex-col flex-row md:gap-5 items-start sm:items-start sm:justify-center justify-evenly w-full">
            ...
            <div className="sm:bottom-[] flex flex-col items-start justify-start sm:m-[] sm:mb-5 md:mt-0 mt-4 sm:top-[]">
              <Text
            ...
            <div
              className="common-pointer flex-col hidden items-start justify-start md:mt-0 mt-[11px]"
              onClick={() => navigate(-1)}
            >
              <Text
                className="font-poppins font-semibold text-red_400"
            ...
            <div className="flex flex-col items-start justify-start md:mt-0 mt-[11px]">
              <Text
                className="font-poppins font-semibold sm:m-[] sm:mb-[-18px] text-red_400"
                variant="body1"
              >
                Get in touch
              </Text>
